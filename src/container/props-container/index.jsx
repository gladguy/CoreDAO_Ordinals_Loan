  ...
  function ComponentWithRouterProp(props) {
    ...
    const fetchCoreDaoPrice = async () => {
      ...
      try {
        ...
        // );
        // // console.log("coreDaoData", coreDaoData);
        // if (coreDaoData.data[0]?.length) {
        //   const coreDaoValue = coreDaoData.data[0].flat();
        //   dispatch(setCoreDaoValue(coreDaoValue[1]));
        // } else {
        // fetchCoreDaoPrice();
        if (!coreDaoValue) dispatch(setCoreDaoValue(1.82));
        // }
      } catch (error) {
